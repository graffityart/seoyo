...
export default async function AdminSettingsPage(){
  ...
  return <div className="adminPage">
    ...
    <div className="adminWrap">
      <aside className="adminSide"><h3>상품권 운영 관리</h3><Link href="/admin/orders">교환신청 관리</Link><Link href="/admin/products">상품권 관리</Link><Link href="/admin/rates">상품권 매입률 관리</Link><Link className="active" href="/admin/settings">서비스 운영 설정</Link></aside>
