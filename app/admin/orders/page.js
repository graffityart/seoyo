...
export default async function AdminOrdersPage(){
  ...
  return <div className="adminPage">
    ...
    <div className="adminWrap">
      <aside className="adminSide"><h3>상품권 운영 관리</h3><Link className="active" href="/admin/orders">교환신청 관리</Link><Link href="/admin/products">상품권 관리</Link><Link href="/admin/rates">상품권 매입률 관리</Link><Link href="/admin/settings">서비스 운영 설정</Link><Link href="/admin/notices">공지사항 관리</Link><Link href="/admin/popups">팝업 관리</Link><Link href="/admin/sms">문자 발송 관리</Link></aside>
