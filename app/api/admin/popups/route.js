...
export async function POST(request){
  ...
  const sql=getDb();
  const rows=await sql`INSERT INTO site_popups(title,content,image_url,link_url,is_active,start_at,end_at,sort_order) VALUES(${title},${content},${imageUrl||null},${linkUrl||null},${isActive},${startAt},${endAt},${sortOrder}) RETURNING id`;
